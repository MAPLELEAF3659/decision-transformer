...
model.load_state_dict(torch.load("./checkpoints/checkpoint_1000000.pth"))

# print(f'{train_dataset.vocab_size} / {train_dataset.block_size}')
...
tconf = TrainerConfig(max_epochs=epochs, batch_size=args.batch_size, learning_rate=6e-4,
                      ...
                      ckpt_path=os.path.join('./checkpoints','checkpoint.pth'),model_path=os.path.join('./models','model.pth'))
